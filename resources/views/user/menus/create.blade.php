...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (createButton) {
        createButton.addEventListener('click', function() {
            ...
            // Show loading state
            button.innerHTML = '<span class="spinner-border spinner-border-sm me-1" role="status"></span>作成中...';
    ...
    document.addEventListener('dragstart', function(e) {
        ...
        if (e.target.classList.contains('exercise-card') || e.target.classList.contains('template-card')) {
