...
<div class="card border-0 shadow-sm h-100 d-flex flex-column">
    ...
    <div class="flex-fill overflow-auto p-0">
        <div class="d-flex flex-column gap-2 p-3 exercise-catalog-container">
            ...
            {{-- Exercise Card 7 --}}
            <div class="card border exercise-card w-100" draggable="true" data-exercise="ショルダープレス">
                <div class="card-body p-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="pe-2">
                            <h6 class="card-title mb-1" style="font-size: 0.9rem;">ショルダープレス</h6>
                            <p class="text-muted mb-2" style="font-size: 0.8rem;">肩 • ダンベル</p>
                            <div class="d-flex align-items-center mb-2">
                                <span class="badge bg-success">初級</span>
                            </div>
            ...
            {{-- Exercise Card 8 --}}
            <div class="card border exercise-card w-100" draggable="true" data-exercise="ランジ">
                <div class="card-body p-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="pe-2">
                            <h6 class="card-title mb-1" style="font-size: 0.9rem;">ランジ</h6>
                            <p class="text-muted mb-2" style="font-size: 0.8rem;">脚 • 自重</p>
                            <div class="d-flex align-items-center mb-2">
                                <span class="badge bg-success">初級</span>
                            </div>
