            ...
            <div class="card border template-card" draggable="true">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" 
                                class="btn btn-outline-secondary btn-sm toggle-details" 
                                style="font-size: 0.8rem;"
                                data-bs-toggle="collapse" 
                                data-bs-target="#template1Details">
                            <i class="fa-solid fa-chevron-down me-1" style="font-size: 0.75rem;"></i>
                        </button>
                    </div>
                    
                    {{-- Expanded Details --}}
                    <div class="collapse mt-2" id="template1Details">
                        <div class="border-top pt-2">
                            <div class="mb-2 p-2 bg-light rounded" style="font-size: 0.7rem;" draggable="true">
                                <div class="fw-medium">1. ベンチプレス</div>
                                <div class="text-muted">3セット × 10回 @ 60kg</div>
                            </div>
                            <div class="mb-2 p-2 bg-light rounded" style="font-size: 0.7rem;" draggable="true">
                                <div class="fw-medium">2. プルアップ</div>
                                <div class="text-muted">3セット × 8回</div>
                            </div>
                            <div class="mb-2 p-2 bg-light rounded" style="font-size: 0.7rem;" draggable="true">
                                <div class="fw-medium">3. ショルダープレス</div>
                                <div class="text-muted">3セット × 12回 @ 20kg</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" 
                                ...
                                style="font-size: 0.8rem;"
                                data-bs-toggle="collapse" 
                                data-bs-target="#template2Details">
                            <i class="fa-solid fa-chevron-down me-1" style="font-size: 0.75rem;"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="card-body p-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" 
                                ...
                                style="font-size: 0.8rem;"
                                data-bs-toggle="collapse" 
                                data-bs-target="#template3Details">
                            <i class="fa-solid fa-chevron-down me-1" style="font-size: 0.75rem;"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="card-body p-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" 
                                ...
                                style="font-size: 0.8rem;"
                                data-bs-toggle="collapse" 
                                data-bs-target="#template4Details">
                            <i class="fa-solid fa-chevron-down me-1" style="font-size: 0.75rem;"></i>
                        </button>
                    </div>
                </div>
