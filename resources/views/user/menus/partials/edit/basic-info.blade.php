            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select form-select-sm" id="difficulty">
                        <option value="beginner" {{ ($menu->difficulty ?? '') == 'beginner' ? 'selected' : '' }}>初級者</option>
                        <option value="intermediate" {{ ($menu->difficulty ?? '') == 'intermediate' ? 'selected' : '' }}>中級者</option>
                        <option value="advanced" {{ ($menu->difficulty ?? '') == 'advanced' ? 'selected' : '' }}>上級者</option>
                    </select>
                </div>
