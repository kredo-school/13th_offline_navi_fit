...
<body class="bg-light">
        ...
        <div class="container-xxl py-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-3">
                    <a href="#" class="btn btn-light rounded-circle p-2" aria-label="メニュー一覧に戻る">
                        <i class="bi bi-arrow-left"></i>
                    </a>
                    <div>
                        <h1 class="h5 mb-0 fw-semibold">筋トレメニューA</h1>
                ...
                <div class="d-none d-md-flex gap-2">
                    <a href="#" class="btn btn-primary d-flex align-items-center gap-2" aria-label="メニューを編集">
                        <i class="bi bi-pencil"></i>
                        <span>編集</span>
                    </a>
                    <button type="button" class="btn btn-danger d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#deleteModal" aria-label="メニューを削除">
        ...
        <div class="card shadow-sm border mb-4">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div class="flex-fill">
                        <h2 class="h3 fw-bold mb-2">筋トレメニューA</h2>
                        <p class="text-muted mb-3">初心者向けの全身を鍛える基本的なメニューです。週3回の実施を推奨します。</p>
                        
                        <div class="d-flex flex-wrap gap-3 small text-muted mb-3">
                            <div class="d-flex align-items-center gap-1">
                                <i class="bi bi-calendar"></i>
                                <span>作成日: 2024年3月15日</span>
                            </div>
                            <div class="d-flex align-items-center gap-1">
    ...
    <div class="d-md-none position-fixed bottom-0 start-0 end-0 bg-white border-top p-3">
        <div class="d-flex gap-2">
            <a href="#" class="btn btn-primary flex-fill d-flex align-items-center justify-content-center gap-2" aria-label="メニューを編集">
                <i class="bi bi-pencil"></i>
                <span>編集</span>
            </a>
            <button type="button" class="btn btn-danger flex-fill d-flex align-items-center justify-content-center gap-2" data-bs-toggle="modal" data-bs-target="#deleteModal" aria-label="メニューを削除">
                <i class="bi bi-trash"></i>
                <span>削除</span>
            </button>
        </div>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-4">
                        <p class="text-muted mb-0">
                            <span class="fw-medium text-dark">筋トレメニューA</span>
                            を削除します。この操作は取り消せません。
                        </p>
                    </div>
                    
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-outline-secondary flex-fill" data-bs-dismiss="modal">キャンセル</button>
                        <button type="button" class="btn btn-danger flex-fill">削除する</button>
                    </div>
                </div>
            </div>
        </div>
